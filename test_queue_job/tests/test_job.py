...
class TestJobsOnTestingMethod(common.TransactionCase):
    ...
    def test_set_enqueued(self):
        ...
        self.assertEqual(job_a.date_enqueued,
    ...
    def test_set_started(self):
        ...
        self.assertEqual(job_a.date_started,
                          datetime(2015, 3, 15, 16, 41, 0))
    ...
    def test_set_done(self):
        ...
        self.assertEqual(job_a.result, 'test')
        self.assertEqual(job_a.date_done,
                          datetime(2015, 3, 15, 16, 41, 0))
    ...
    def test_job_identity_key_func_exact(self):
        ...
        hasher.update(str((1, 'foo')))
        hasher.update(str(sorted({'bar': 'baz'}.items())))
